...
# C defines
# C_DEFS = -DUSE_HAL_DRIVER -DSTM32F469xx -DUSE_STM32479I_EVAL -DUSE_USB_HS -DUSE_IOEXPANDER -DHAL_HCD_MODULE_ENABLED -DTIMER_BASELINE
...
$(BUILD9_DIR)/$(TARGET).elf:$(ASMOBJECTS) $(OBJECTS) Makefile
	...
	# $(OP) -dot-callgraph $(BUILD9_DIR)/$(TARGET).elf.0.5.precodegen.bc > /dev/null
