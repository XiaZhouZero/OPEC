...
static void Program_Init(uint32_t a, uint32_t b, uint32_t c, uint32_t d, uint32_t f);
...
// void handle_unlock_input(unsigned int one, struct test_struct test, unsigned int exp, unsigned int ms, unsigned int *unlock_count, unsigned int unused)
void handle_unlock_input(unsigned int one, unsigned int exp, unsigned int ms, unsigned int *unlock_count, unsigned int unused)
{
...
// void use_test_array(int test_gv) {
//   test_gv += 1;
// }
...
int main(void)
{
    ...
    // handle_unlock_input(one, test, exp, ms, &unlock_count, unsed_v);
    handle_unlock_input(one, exp, ms, &unlock_count, unsed_v);
...
void config_and_check_uarthandle() {
  config_uarthandle();
  check_uarthandle();
}
