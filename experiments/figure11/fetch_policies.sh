...
cp ${OI_DIR}stm32469I/Camera_To_USBDisk/SW4STM32/STM32469I_EVAL/build9/func_memdep_gv_peri_ptr_bf_operation.json ./policies/OPEC/Camera_To_USBDisk
...
cp ${OI_DIR}stm32469I/FatFs_uSD/SW4STM32/STM32469I_EVAL/build9/func_memdep_gv_peri_ptr_bf_operation.json ./policies/OPEC/FatFs_uSD
...
cp ${OI_DIR}stm32469I/LCD_AnimatedPictureFromSDCard/SW4STM32/STM32469I_EVAL/build9/func_memdep_gv_peri_ptr_bf_operation.json ./policies/OPEC/LCD_AnimatedPictureFromSDCard
...
cp ${OI_DIR}stm32469I/LCD_PicturesFromSDCard/SW4STM32/STM32469I_EVAL/build9/func_memdep_gv_peri_ptr_bf_operation.json ./policies/OPEC/LCD_PicturesFromSDCard
...
cp ${OI_DIR}stm32469I/LwIP_TCP_Echo_Server/SW4STM32/STM32469I_EVAL/build9/func_memdep_gv_peri_ptr_bf_operation.json ./policies/OPEC/LwIP_TCP_Echo_Server