...
APP_ROOT = $(STM32_ROOT)/Projects/STM32469I_EVAL/Applications/Display/LCD_PicturesFromSDCard/
######################################
# source
######################################
# C sources
...
#     ../../../Middlewares/Third_Party/FatFs/Drivers/sd_diskio.c\
...
C_SOURCES = \
	...
	${APP_ROOT}Src/fatfs_storage.c \
	${STM32_ROOT}Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal.c \
	${STM32_ROOT}Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_fmc.c \
	${STM32_ROOT}Middlewares/Third_Party/FatFs/src/diskio.c \
	${STM32_ROOT}Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_i2c.c \
	${STM32_ROOT}Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_flash.c \
	${APP_ROOT}Src/main.c \
	${APP_ROOT}Src/stm32f4xx_it.c \
	${STM32_ROOT}Drivers/BSP/STM32469I_EVAL/stm32469i_eval_sd.c \
	${STM32_ROOT}Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_sdram.c \
	${STM32_ROOT}Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_ltdc_ex.c \
	${STM32_ROOT}Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_sdmmc.c \
	${APP_ROOT}Src/system_stm32f4xx.c \
	${STM32_ROOT}Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_cortex.c \
	${STM32_ROOT}Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_dma2d.c \
	${STM32_ROOT}Drivers/BSP/Components/mfxstm32l152/mfxstm32l152.c \
	${STM32_ROOT}Drivers/BSP/Components/otm8009a/otm8009a.c \
	${STM32_ROOT}Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_dsi.c \
	${STM32_ROOT}Drivers/BSP/STM32469I_EVAL/stm32469i_eval_io.c \
	${STM32_ROOT}Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_sd.c \
	${STM32_ROOT}Middlewares/Third_Party/FatFs/src/ff.c \
	${STM32_ROOT}Drivers/BSP/STM32469I_EVAL/stm32469i_eval_lcd.c \
	${STM32_ROOT}Drivers/BSP/STM32469I_EVAL/stm32469i_eval_sdram.c \
	${STM32_ROOT}Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_flash_ex.c \
	${STM32_ROOT}Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_ltdc.c \
	${STM32_ROOT}Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_i2c_ex.c \
	${STM32_ROOT}Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_uart.c \
	${STM32_ROOT}Middlewares/Third_Party/FatFs/src/ff_gen_drv.c \
	...
	${STM32_ROOT}Drivers/BSP/STM32469I_EVAL/stm32469i_eval.c \
	${STM32_ROOT}Middlewares/Third_Party/FatFs/src/drivers/sd_diskio.c \
...
#     -I ../../../Drivers/BSP/Components/ft6x06\
...
C_INCLUDES = \
	-I${APP_ROOT}Inc \
	-I${STM32_ROOT}Drivers/CMSIS/Device/ST/STM32F4xx/Include \
	-I${STM32_ROOT}Drivers/CMSIS/Include \
	-I${STM32_ROOT}Drivers/STM32F4xx_HAL_Driver/Inc \
	-I${STM32_ROOT}Drivers/BSP/STM32469I_EVAL \
	-I${STM32_ROOT}Drivers/BSP/Components/mfxstm32l152 \
	-I${STM32_ROOT}Drivers/BSP/Components/ft6x06 \
	-I${STM32_ROOT}Drivers/BSP/Components/Common \
	-I${STM32_ROOT}Drivers/BSP/Components \
	-I${STM32_ROOT}Utilities \
	-I${STM32_ROOT}Utilities/Fonts \
	-I${STM32_ROOT}Middlewares/Third_Party/FatFs/src \
	-I${STM32_ROOT}Middlewares/Third_Party/FatFs/src/drivers
...
$(BUILD4_DIR):
	mkdir $@
	cp $(BUILD9_DIR)/$(TARGET)_final_policy.json $(BUILD9_DIR)/$(TARGET)_final_policy_bk.json
