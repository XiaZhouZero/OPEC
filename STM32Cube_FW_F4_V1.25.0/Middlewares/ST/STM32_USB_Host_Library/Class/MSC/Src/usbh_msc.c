...
/**
  ...
  * @retval USBH Status
  */
MSC_HandleTypeDef opec_msc_handle;
...
static USBH_StatusTypeDef USBH_MSC_InterfaceInit(USBH_HandleTypeDef *phost)
{
  ...
  // phost->pActiveClass->pData = (MSC_HandleTypeDef *)USBH_malloc(sizeof(MSC_HandleTypeDef));    // commented by zhouxia at 2021/5/13
  MSC_HandleTypeDef *tmp_ptr = &opec_msc_handle;
  phost->pActiveClass->pData = (void *)tmp_ptr;
...
static USBH_StatusTypeDef USBH_MSC_InterfaceDeInit(USBH_HandleTypeDef *phost)
{
  ...
  {
    // USBH_free(phost->pActiveClass->pData);   // commented by zhouxia at 2021/5/13
